...
Climate data and resilience planning
...
4. Access the API at `http://localhost:8005`
5. API docs at `http://localhost:8005/docs`
...
uvicorn server.main:app --reload --port 8005
```
